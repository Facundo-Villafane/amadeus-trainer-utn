// src/components/profile/MyPNRsSection.jsx
...
import { FiSearch, FiCalendar, FiMap, FiTag, FiClock } from 'react-icons/fi';
import toast from 'react-hot-toast';

export default function MyPNRsSection() {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      ...
      {/* Search Bar */}
      <div className="mt-4 flex items-center max-w-md mb-6">
                      ...
                      <ul className="mt-1 space-y-1">
                        {pnr.segments.map((segment, idx) => (
                          <li key={idx} className="text-sm text-gray-900 flex items-center">
                            <FiMap className="mr-1 h-4 w-4 text-gray-400" />
...
// Modal component for PNR details
function PNRDetailModal({ selectedPNR, onClose, onCancel }) {
  return (
